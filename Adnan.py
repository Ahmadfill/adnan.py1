...
happy my birthday  🎂💙
    ...
    █▄▄█ █░░█░░┬░░█░░█ █▄▄█
          ...
          //////id rubik' #new ~> @Server0 off zadam//////
...
print (Fore.YELLOW + "")
time.sleep(1.7)
print ("                       ID RUBIKA @SHUBADEHBAZ IM MOJTABA")
print ("                         ID telegram @Creator_Typeri")
print ("                          New Id rubika : @Sallavati ")
print(f"{blue} ")
time.sleep(1.0)
print ("__________")
time.sleep(0.7)
...
if up == "3":
        print ('code group ≠>' + '%s%s (/*!50000(4.2.5.7/f////g.h/4.3.4.6.7.9.8.5.2.5.7.9.5.2.3.6.8.0.0.7.3.1/)) %s' % (fg('white'), bg('black'), attr('reset')))
